...
<body>
		...
		<div class="row">
			<ul id="menu">
				...
				<li>
					...
					Trại Găng, Bạch Mai, HBT, HN
				</li>
				<li>
					<a href="https://www.facebook.com/hien.bu.0402" id="fb">
						<i class="fa fa-facebook" ></i>
					</a>
				</li>
				<li>
					<a href="https://www.facebook.com/hien.bu.0402" id="googlep">
	...
	<div class="container-fluid bg-img">
		<div class="container">
			<div class="row">
				<div class="col-md-3">
					<a href="index.php"><abbr title="Trang chu" style="border: none; cursor: pointer;"><img src="public/imgs/logo-icon/1logo-medium.png" alt="logo Sunrise" /></abbr></a>
				</div>
				<div class="col-md-6">
